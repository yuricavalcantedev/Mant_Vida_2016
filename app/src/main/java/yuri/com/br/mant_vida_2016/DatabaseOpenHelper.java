...
public class DatabaseOpenHelper extends SQLiteAssetHelper {
    ...
    //BD_VERSION = 8 (version 8 will is in google play, the next version 9)
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        switch (newVersion) {
            ...
            //Update 7 - To Correct the readings of 3 first months.
            case 7:
                update7Table1(db);
                break;
            //Update 7 - To create some tables to "Devotional".
            case 8:
                update8AddTables(db);
                break;
        }
    ...
    private void update8AddTables(SQLiteDatabase db){

        //SUMMARY
        // 'queryCreateTable1' is a query to create the table tbldevotional_1tri
        // 'queryCreateTable2' is a query to create the table tbldevotional_2tri
        // 'queryCreateTable3' is a query to create the table tbldevotional_3tri
        // 'queryCreateTable4' is a query to create the table tbldevotional_4tri


        String queryCreateTable1 = "CREATE TABLE tbldevotional_1tri (\n" +
                "    mes                       INTEGER NOT NULL,\n" +
                "    dia                       INTEGER NOT NULL,\n" +
                "    Titulo                    STRING,\n" +
                "    Versiculo_Memorizar       STRING,\n" +
                "    Aprendizado               STRING,\n" +
                "    Mensagem_De_Deus_Para_Mim STRING\n" +
                ");\n";

        String queryCreateTable2 = "CREATE TABLE tbldevotional_2tri (\n" +
                "    mes                       INTEGER NOT NULL,\n" +
                "    dia                       INTEGER NOT NULL,\n" +
                "    Titulo                    STRING,\n" +
                "    Versiculo_Memorizar       STRING,\n" +
        ...
        String queryCreateTable3 = "CREATE TABLE tbldevotional_3tri (\n" +
                "    mes                       INTEGER NOT NULL,\n" +
                "    dia                       INTEGER NOT NULL,\n" +
                "    Titulo                    STRING,\n" +
                "    Versiculo_Memorizar       STRING,\n" +
        ...
        String queryCreateTable4 = "CREATE TABLE tbldevotional_4tri (\n" +
                "    mes                       INTEGER NOT NULL,\n" +
                "    dia                       INTEGER NOT NULL,\n" +
                "    Titulo                    STRING,\n" +
                "    Versiculo_Memorizar       STRING,\n" +
        ...
        //run the querys that update the database.
